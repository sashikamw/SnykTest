...
async function startTest() {
    ...
    let osBrowserConfigWithSmartScroll = configFile.BrowserSectionWithSmartScroll;
    let osBrowserConfigWithOutSmartScroll = configFile.BrowserSectionWithoutSmartScroll;
